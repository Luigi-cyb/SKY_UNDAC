                ...
                <div class="border-t border-gray-200 pt-10 mt-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 px-8">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm font-bold text-gray-900">DR. LUIS ALBERTO PACHECO</p>
                            <p class="text-xs text-gray-600 mt-1">Director de la E.F.P. de Ingenieria de Sistemas y Computacion</p>
                        ...
                        <div class="text-center">
                            <div class="border-t-2 border-gray-800 mb-3 pb-3 mx-auto w-56"></div>
                            <p class="text-sm font-bold text-gray-900">DR. TITO MARCIAL ARIAS ARZAPALO</p>
                            <p class="text-xs text-gray-600 mt-1">Decano de la Facultad de Ingenieria</p>
                            <p class="text-xs text-gray-500">Universidad Nacional Daniel Alcides Carrión</p>
                        </div>
                    </div>
                </div>
