<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Modifica la información del curso: <span class="font-semibold">{{ $curso->nombre }}</span></p>
            </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="codigo" id="codigo" value="{{ old('codigo', $curso->codigo) }}" required
                            ...
                            <div>
                                ...
                                <select name="modalidad_id" id="modalidad_id" required
                                    ...
                                    @foreach($modalidades as $modalidad)
                                        <option value="{{ $modalidad->id }}" {{ old('modalidad_id', $curso->modalidad_id) == $modalidad->id ? 'selected' : '' }}>
                                            {{ $modalidad->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="estado" id="estado" required
                                    ...
                                    <option value="convocatoria" {{ old('estado', $curso->estado) == 'convocatoria' ? 'selected' : '' }}>📢 En Convocatoria</option>
                                    <option value="en_curso" {{ old('estado', $curso->estado) == 'en_curso' ? 'selected' : '' }}>✅ En Curso</option>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="duracion_horas" id="duracion_horas" value="{{ old('duracion_horas', $curso->horas_academicas) }}" required min="1"
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="nota_minima_aprobacion" id="nota_minima_aprobacion" value="{{ old('nota_minima_aprobacion', $curso->nota_minima_aprobacion) }}" required min="0" max="20"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="porcentaje_asistencia_minima" id="porcentaje_asistencia_minima" value="{{ old('porcentaje_asistencia_minima', $curso->asistencia_minima_porcentaje) }}" required min="0" max="100"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_inicio" id="fecha_inicio" 
                                    value="{{ old('fecha_inicio', $curso->fecha_inicio ? \Carbon\Carbon::parse($curso->fecha_inicio)->format('Y-m-d') : '') }}" 
                                    required
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_fin" id="fecha_fin" 
                                    value="{{ old('fecha_fin', $curso->fecha_fin ? \Carbon\Carbon::parse($curso->fecha_fin)->format('Y-m-d') : '') }}" 
                                    required
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="cupo_minimo" id="cupo_minimo" value="{{ old('cupo_minimo', $curso->cupo_minimo) }}" required min="1"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="cupo_maximo" id="cupo_maximo" value="{{ old('cupo_maximo', $curso->cupo_maximo) }}" required min="1"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">
                            </div>
                    ...
                    <div class="p-6">
                        <div class="max-w-md">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="costo" id="costo" value="{{ old('costo', $curso->costo_inscripcion) }}" required min="0"
    ...
    <h3 class="text-lg font-bold !text-white flex items-center">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3"
                                ...
                                class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">{{ old('descripcion', $curso->descripcion) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="objetivos" id="objetivos" rows="3"
                                ...
                                class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">{{ old('objetivos', $curso->objetivos) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="competencias" id="competencias" rows="3"
                                ...
                                class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition">{{ old('competencias', $curso->competencias) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="temario" id="temario" rows="6"
                                ...
                                class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition font-mono text-sm">{{ old('temario', $curso->temario) }}</textarea>
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl">
                    ...
                    <button type="submit" 
        class="inline-flex items-center px-6 py-3 bg-blue-700 border border-transparent rounded-lg font-bold text-sm !text-white uppercase tracking-wide hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 transition shadow-lg transform hover:scale-105">
         <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
