<x-app-layout>
   ...
   <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-6">
        <form method="GET" action="{{ route('estudiantes.index') }}" class="flex gap-2">
            <input type="text" name="buscar" 
                   value="{{ request('buscar') }}"
                   placeholder="Buscar por DNI, Nombre, Código o Correo..."
                   class="flex-1 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 transition">
            
            <button type="submit" 
                    class="inline-flex items-center px-6 py-2 border border-transparent rounded-lg font-bold text-sm uppercase tracking-wide transition shadow-lg"
            ...
            <a href="{{ route('estudiantes.index') }}" 
               class="inline-flex items-center px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold rounded-lg transition">
