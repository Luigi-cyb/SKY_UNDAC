<x-app-layout>
    ...
    <button onclick="document.getElementById('modalImportar').classList.remove('hidden')"
            ...
            style="background: linear-gradient(to right, #1e40af, #1e3a8a) !important; color: white !important;">
...
<div id="modalImportar" class="hidden fixed inset-0 bg-gray-900 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
    <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-xl px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <button onclick="document.getElementById('modalImportar').classList.add('hidden')" 
        ...
        <form action="{{ route('estudiantes.importar') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
                    ...
                    <div class="flex">
                        ...
                        <div class="text-sm text-blue-700">
                            ...
                            <ul class="list-disc list-inside space-y-1 text-xs">
                                <li>Columnas requeridas: DNI, Nombres, Apellidos, Correo Institucional</li>
                                <li>Columnas opcionales: Código, Teléfono, Dirección, EISC (Sí/No), Ciclo</li>
            ...
            <div class="mb-6">
                ...
                <input type="file" 
                       ...
                       accept=".xlsx,.xls" 
                       required
                       class="w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">
                <p class="text-xs text-gray-500 mt-2">Archivos permitidos: Excel (.xlsx, .xls)</p>
            </div>

            <div class="mb-6">
                <a href="{{ route('estudiantes.plantilla') }}" 
                   class="inline-flex items-center px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition font-semibold text-sm">
                    <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t">
                <button type="button" 
                        onclick="document.getElementById('modalImportar').classList.add('hidden')"
                        class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold">
                    Cancelar
                </button>
                <button type="submit" 
                        class="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold">
                    Importar Estudiantes
                </button>
            </div>
        </form>
