    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Completa la información del nuevo docente</p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('docentes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="telefono" id="telefono" value="{{ old('telefono') }}" maxlength="15"
                                        ...
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 transition pl-10">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="direccion" id="direccion" rows="2"
                                    placeholder="Ej: Jr. Lima 123, Yanacancha, Pasco"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 transition">{{ old('direccion') }}</textarea>
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="formacion_academica" id="formacion_academica" rows="3"
                                    placeholder="Ej: Magíster en Ingeniería de Sistemas - UNDAC (2020)&#10;Ingeniero de Sistemas - UNDAC (2015)"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 transition">{{ old('formacion_academica') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="experiencia_profesional" id="experiencia_profesional" rows="3"
                                    placeholder="Ej: Docente universitario (2015-actualidad)&#10;Desarrollador Senior (2012-2015)"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 transition">{{ old('experiencia_profesional') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="especialidades" id="especialidades" rows="2"
                                    placeholder="Ej: Desarrollo Web, Bases de Datos, Inteligencia Artificial"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 transition">{{ old('especialidades') }}</textarea>
                            </div>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl mb-6">
                    <div class="px-6 py-4" style="background: linear-gradient(to right, #dc2626, #b91c1c) !important;">
                        <h3 class="text-lg font-bold flex items-center" style="color: white !important;">
                            <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
