...
// ✅ RUTAS DE FIRMA - ANTES DEL RESOURCE
Route::get('certificados/{certificado}/descargar-sin-firmar', [CertificadoController::class, 'descargarPDFSinFirmar'])
    ->name('certificados.descargar-sin-firmar');
...
// ✅ RESOURCE AL FINAL (para que no sobrescriba las rutas personalizadas)
Route::resource('certificados', CertificadoController::class)->except(['show', 'destroy']);

// ✅ SHOW Y DESTROY AL FINAL (para control específico)
