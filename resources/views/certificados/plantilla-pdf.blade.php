...
<div class="page page-certificado">
    ...
    <div class="cert-content">
        <div class="cert-header">
            ...
            <div class="uni-dept">E.F.P. de Ingenieria de Sistemas y Computacion</div>
        ...
        <div class="cert-body">
            ...
            <div class="curso-intro">Por haber participado en la ponencia de</div>
    ...
    $mesInicio = $meses[$fechaInicio->month - 1];
@endphp

<strong>Realizado el {{ $fechaInicio->format('d') }} de {{ $mesInicio }} de {{ $fechaInicio->format('Y') }}</strong>, con una duración de <strong>{{ $curso->horas_academicas ?? 24 }} horas.</strong>
            </div>
        </div>
...
<div class="page">
    ...
    <div class="temario-content-wrapper">
        <div class="temario-header">
            ...
            <div class="temario-subtitle">Universidad Nacional Daniel Alcides Carrión - E.F.P. DE INGENIERIA DE SISTEMAS Y COMPUTACION</div>
        </div>

        <div class="temario-content">
            @if($curso->temario)
                @php
                    $temarioLimpio = preg_replace('/[^a-zA-Z0-9\s:]/u', '', $curso->temario);
