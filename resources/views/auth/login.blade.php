...
<head>
    ...
    <title>SKY-UNDAC | Iniciar Sesión</title>
    ...
    <style>
        * {
        ...
        .bg-login::before {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(135deg, rgba(30, 58, 138, 0.6) 0%, rgba(37, 99, 235, 0.5) 100%);
        }
        .glass-card {
...
<body class="font-sans antialiased">
    <div class="min-h-screen flex items-center justify-center bg-login p-4">
        ...
        <div class="relative z-10 w-full" style="max-width: 520px;">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <label for="remember_me" class="flex items-center cursor-pointer">
                            <input id="remember_me" 
                                   type="checkbox" 
                                   name="remember"
                                   class="h-3.5 w-3.5 text-blue-700 focus:ring-blue-600 border-gray-300 rounded">
                            <span class="ml-2 text-xs text-gray-700 font-medium">Recordarme</span>
                        </label>
                ...
                <div class="mt-6">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-xs">
                            <span class="px-3 bg-white text-gray-500 font-medium">¿No tienes cuenta?</span>
                        </div>
                    </div>
