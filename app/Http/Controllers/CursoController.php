...
public function update(CursoRequest $request, Curso $curso)
{
    ...
    try {
        ...
        // Usar las fechas existentes si no se envían nuevas
        $fechaInicio = $validated['fecha_inicio'] ?? $curso->fecha_inicio;
        $fechaFin = $validated['fecha_fin'] ?? $curso->fecha_fin;
        ...
        $cursoData = [
            ...
            'competencias' => $request->input('competencias') ?? $curso->competencias,
            'temario' => $request->input('temario') ?? $curso->temario,
            'perfil_ingreso' => $validated['requisitos'] ?? $curso->perfil_ingreso,
            'categoria_id' => $validated['categoria_id'],
            'modalidad_id' => $validated['modalidad_id'],
            'nivel' => $request->input('nivel') ?? $curso->nivel,
            'horas_academicas' => $validated['duracion_horas'],
            'cupo_minimo' => $validated['cupo_minimo'],
            'cupo_maximo' => $validated['cupo_maximo'],
