...
@else
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <div class="flex items-center">
            ...
            <span class="text-sm text-yellow-800 font-semibold">Certificado en proceso de firma digital</span>
        </div>
        <p class="text-xs text-yellow-700 mt-2 ml-7">
            Tu certificado estará disponible para descarga una vez que sea firmado digitalmente por las autoridades de la universidad.
        </p>
    </div>
@endif
</div>
